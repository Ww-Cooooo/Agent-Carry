...
const fixture = mkdtempSync(join(tmpdir(), "agent-carry-promotion-fixture-"));
...
try {
  ...
  const levelTicket = (level, purpose = "review-and-promote-formal-agent-carry-asset") => {
  ...
  const level3Ticket = (purpose = "review-and-promote-formal-agent-carry-asset") => levelTicket(3, purpose);
