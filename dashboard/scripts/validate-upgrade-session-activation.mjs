...
expect(upgradeCli.includes('decision: "ai-carry-upgrade-target-runtime-validated"')
  ...
  "2.0.6 upgrade CLI self-attests current-session activation or behavior acceptance");
...
console.log("Upgrade session activation passed high-information invalid, rollback, continuity, and generic-JSON no-self-attestation cases plus the 2.0.6 local-CLI boundary.");
