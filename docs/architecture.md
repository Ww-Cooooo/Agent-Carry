...
- **当前阶段**：`1.2.0`；在 `1.1.3` 的修改质量与实例升级保护基础上，增加按需私密资产目录、导出覆盖对账和大型资料分卷迁移
- **最近更新**：2026-08-20
...
| GitHub 私有仓库中的脱敏安全副本与本地隐私迁移 | 1.2.0 | 已拆成登记范围、GitHub 脱敏安全副本、私密导出和私密导入动作；导出与范围管理在同一卡片和连续弹窗中完成，导入先识别完整输出文件夹、材料不确定或尚未导出；普通启动不加载私密目录，外部资料根必须由用户明确登记 |
