...
- **当前阶段**：AI Carry `2.0.1` 正式版本；产品改名与兼容迁移仍沿用 2.0.0 的边界，新增修复升级确认被动态核验时间阻断的问题。公开 1.4.8、未公开 1.4.9 与 2.0.0 都可直接通过既有看板升级链迁移。完整审计时间继续保留，确认只绑定稳定官方事实；实例身份、历史、资产、Skill、工作区、本机与私密层保持。实例替换仍须现场闭合固定标签、正式 Release、目标整树和本次用户确认；远程仓库改名是以后单独授权的动作
- **最近更新**：2026-08-31
