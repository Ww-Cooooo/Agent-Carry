...
- **当前阶段**：`1.4.4` 正式发布；在保留 1.4.3 会话激活闭环、1.4.2 回执连续性、1.4.1 首次实例化闭包和 1.4.0 持续进化兼容协定的同时，加入用户主动触发的 Skill 工坊、本地草稿自动脱敏与外来 Skill 只读隔离检查；实例替换仍要求固定标签、Release、清单、解压树与用户对该次升级的明确选择一致
- **最近更新**：2026-08-28
