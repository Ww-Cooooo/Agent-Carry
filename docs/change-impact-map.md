...
- AI Carry 自有内容新增或修改国家、地区、行政区划、地图、旗帜或国家／地区选择器时，按需加载 `core/protocols/TERRITORY_TERMINOLOGY.md`，同步中英文看板、README／安装入口、无障碍标签、复制请求、Pages 演示、升级检查和私密到公开门禁。用户原文与来源证据保持原样；地图、旗帜和复杂主权语境必须由 Level 3 做人工语义复核，不能只相信自动扫描。
